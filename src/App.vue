                                    ...
                                    <div class="px-5 lg:flex-1">
                                        ...
                                        <div class="flex mt-6 rounded-12px border border-black-2">
                                            <div class="flex items-center justify-center py-2 px-2">
                                                <button @click="decreaseQuantity(item.id)" class="bg-gray-5 rounded-sm w-5 h-5 flex items-center justify-center focus:outline-none" type="button">
                                            ...
                                            <div class="flex items-center justify-center py-2 px-2">
                                                <button @click="increaseQuantity(item.id)" class="bg-gray-5 rounded-sm w-5 h-5 flex items-center justify-center focus:outline-none" type="button">
                                                    <p class="text-gray-3">+</p>
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <div class="lg:flex-1 lg:mr-24 lg:px-4">
                        <form @submit.prevent>
                                ...
                                <div class="mt-3 lg:mt-6">
                                    ...
                                    <div class="flex items-center mt-1 p-3 border border-gray-3 rounded-12px">
                                        ...
                                        <div class="inline-block text-xs leading-4 ml-3 w-full">
                                            <input class="bg-transparent focus:outline-none w-full" type="email" v-model.trim="formData.email" placeholder="Enter your email..." id="email" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-4">
                                    ...
                                    <div class="flex items-center mt-1 p-3 border border-gray-3 rounded-12px">
                                        ...
                                        <div class="inline-block text-xs leading-4 ml-3 w-full">
                                            <input class="bg-transparent focus:outline-none w-full" type="text" v-model.number="formData.phone" placeholder="Enter your phone..." id="phone" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-10">
                                ...
                                <div class="mt-3 lg:mt-6">
                                    ...
                                    <div class="flex items-center mt-1 p-3 border border-gray-3 rounded-12px">
                                        ...
                                        <div class="inline-block text-xs leading-4 ml-3 w-full">
                                            <input class="bg-transparent focus:outline-none w-full" type="text" v-model.trim="formData.name" id="name" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-4">
                                    ...
                                    <div class="flex items-center mt-1 p-3 border border-gray-3 rounded-12px">
                                        ...
                                        <div class="inline-block text-xs leading-4 ml-3 w-full">
                                            <input class="bg-transparent focus:outline-none w-full" type="text" placeholder="Your address.." v-model.trim="formData.address" id="address" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-3">
                                    ...
                                    <div class="flex items-center mt-1 p-3 border border-gray-3 rounded-12px">
                                        ...
                                        <div class="inline-block text-xs leading-4 ml-3 w-full">
                                            <input class="bg-transparent focus:outline-none w-full" type="text" placeholder="Your city.." v-model.trim="formData.city" id="city" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex mt-3 justify-between">
                                    <div class="w-48">
                                        ...
                                        <div class="flex items-center mt-1 p-3 border border-gray-3 rounded-12px">
                                            ...
                                            <div class="inline-block text-xs leading-4 ml-3 w-full">
                                                <select name="country" id="country" class="focus:outline-none w-full" v-model="formData.country" required>
                                    ...
                                    <div class="w-48 ml-4">
                                        ...
                                        <div class="flex items-center mt-1 p-3 border border-gray-3 rounded-12px">
                                            ...
                                            <div class="inline-block text-xs leading-4 ml-3 w-full">
                                                <input class="bg-transparent focus:outline-none w-full" type="text" placeholder="Your postal code.." v-model.trim="formData.postalCode" id="postalCode" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mt-5 text-right">
                                <div class="inline-block rounded-12px bg-orange-400 hover:bg-orange-500">
                                    <button @click="submitForm()" class="text-base py-4 px-10 leading-5 text-white focus:outline-none">Continue</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    methods: {
        ...
        decreaseQuantity(itemId) {
            this.cart.forEach(function (item) {
                if (item.id == itemId) {
                    if (item.items > 0) {
                        //Decrease quantity for matching item when greater than 0
                        item.items--;
                    }
                }
            })
        ...
        validateForm() {
            if(this.formData.email && this.formData.phone && this.formData.name && this.formData.address && this.formData.city && this.formData.country && this.formData.postalCode){
                return true;
            } else {
                return false;
            }
        ...
        //Successfull alert
        showAlert() {
            this.$swal("Order Confirmed!", "Your order confirmation has been sent to your email!", "success");
        },
    },
    computed: {
        fetchTotal() {
